...
function setColorButtons(path) {
    ...
    setButtonColor(document.getElementById("scale-king"), o[0]);
    setButtonColor(document.getElementById("scale-queen"), o[1]);
    setButtonColor(document.getElementById("scale-emperor"), o[2]);
    setButtonColor(document.getElementById("scale-empress"), o[3]);
}
